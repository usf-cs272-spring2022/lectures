...
public class BoundedBuffer<E> {
	// Must upcast and downcast to use generic types here! See:
	...
	/**
	 * Returns the item cast as an element of type E.
	 *
	 * @param item the item to cast
	 * @return the casted item
	 *
	 * @see <a href="https://docs.oracle.com/javase/tutorial/java/generics/restrictions.html#createArrays">
	 *   Generic Restrictions</a>
	 */
