...
public class NestedMapDemo {
	...
	/**
	 * Stores a set of words by the length of that word. For example, the word
	 * "ant" has 3 characters. The word "bat" also has length 3. So both words
	 * should appear in the set for words of length 3.
	 *
	 * @param args unused
	 */
