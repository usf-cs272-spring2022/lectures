...
public class SetDemo {
	...
	public static double benchmark(int size) throws InterruptedException {
		...
		String format = "%15s : %.5f seconds%n";
		System.out.printf(format, set1.getClass().getSimpleName(), average1);
		System.out.printf(format, set2.getClass().getSimpleName(), average2);
		System.out.printf(format, set3.getClass().getSimpleName(), average3);
		System.out.println();
