...
public class ShapeDemo {
	...
	private static void printInfo(String variable, Shape shape) {
		System.out.printf(format, variable, shape.getClass().getName(),
				shape.hashCode(), shape.getName(), shape.toString(), shape.area());
	}
	...
	private static void printHead() {
		...
		System.out.printf("| %-8s | %-11s | %-10s | %-9s | %-15s | %-6s |%n",
				"VARIABLE", "CLASS", "HASHCODE", "TYPE", "STRING", "AREA");
		System.out.println(divider);
	}
	...
	public static void main(String[] args) {
		...
		System.out.printf(format, "r1", r1.getClass().getName(), r1.hashCode(),
		...
		System.out.printf(format, "r2", r2.getClass().getName(), r2.hashCode(),
				r2.getName(), r2.toString(), r2.area());
		...
		System.out.printf(format, "r3", r3.getClass().getName(), r3.hashCode(),
		 ...
		 */
		Square q1 = (Square) r3;
		System.out.printf(format, "q1", q1.getClass().getName(), q1.hashCode(),
