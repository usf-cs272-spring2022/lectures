...
public class CastDemo {
	...
	public static void arrayDemo() {
		...
		Number[] numbers = new Number[] { Double.valueOf(3.14), Integer.valueOf(42),
	...
	public static void objectDemo() {
		...
		Object[] objects = new Object[] { new CastDemo(), new String[] { "a" },
				new StringBuilder("potato"), Integer.valueOf(42), List.of(3.14, 2.0) };
	...
	public static void interfaceDemo() {
		...
		CharSequence[] chars = new CharSequence[] { new String("apple"),
				new StringBuffer("banana"), new StringBuilder("carrot") };
