...
public class StringDemo {
	...
	public static void main(String[] args) {
		...
		/*
		 * Notice that the equals() method also considers these objects equivalent
		 * to each other. We actually want this behavior---if the String objects
		 * have the same value, they should be considered equivalent.
		 */
		...
		/*
		 * However, the equals() and == operations do not return the same results
		 * here. Why? Remember, both the content and hashcodes are the same!
		 */
		 ...
		 * content of the String, NOT the internal address of the String object. We
		 * can get the original hashcode implementation using the "system identity"
		 * hashcode instead, which is more likely to give us that information.
		 */
		 ...
		 * objects are equivalent but whether they are the same object internally.
		 * That is usually NOT what we want in our code, hence the recommendation to
		 * use equals() instead of == for any kind of object.
		 */
	}
}
