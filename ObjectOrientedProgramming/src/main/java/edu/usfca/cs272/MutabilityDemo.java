...
public class MutabilityDemo {
	...
	public static void main(String[] args) {
		...
		/*
		 * Keep in mind there is a shortcut syntax of creating arrays (and Strings)
		 * that does not require the new keyword.
		 */
		 ...
		 * it is modifying the internal state (i.e. memory) of that array.
		 */
		 ...
		 *
		 * Since arrays are also mutable, whenever we change the state of this
		 * object, all references to that object will see this modified state.
		 */
		 ...
		 * incrementFirst() method here has a reference to the array, so changes
		 * within that method will be seen outside of the method as well.
		 */
		 ...
		 * When you pass the value to a method, any modifications to that value are
		 * lost when the method scope is exited unless you return those changes.
		 */
